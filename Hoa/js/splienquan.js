function renderSplienquan(products, currentId, containerId = 'splienquan-container') {
    ...
    const html = `
    <h4 style="font-weight:700;margin-bottom:20px;border-top:2px solid #bbb;padding-top:18px;color:#444;">
        Sản phẩm liên quan
    </h4>
    <div style="border:2px solid #bbb; border-radius:16px; padding:18px 8px; background:#fff;">
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            ${slide.map(p => `
                                <div class="card h-100 shadow-sm border-0" style="border-radius:14px;width:240px;">
                                    ...
                                    <div class="card-body text-center" style="border-top:3px solid #888;">
